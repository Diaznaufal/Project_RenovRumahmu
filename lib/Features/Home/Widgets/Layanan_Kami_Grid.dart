...
import 'package:flutter_application_1/Features/BangunBaru/Pages/Bangunbaru_Page.dart';
import '../../Perawatan/Pages/Perawatan_Page.dart';
import 'package:flutter_application_1/Features/Renovasi/Pages/Renovasi_Page.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:flutter_application_1/Features/Material/Pages/Material_Page.dart';
import 'package:provider/provider.dart';

import '../Models/Layanan_Kami.dart';
import '../../Material/Provider/Product_provider.dart';
    ...
    final List<LayananKami> layananList = [
      LayananKami(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => BangunbaruPage()),
          );
        },
      ),
      LayananKami(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => RenovasiPage()),
          );
        },
      ),
      LayananKami(
